...
Current local builds use ESPHome `2026.7.0`. The shared configuration includes compatibility fixes for ESPHome 2026.3 and 2026.4 LVGL changes, and for the 2026.7 image schema change.
:::
