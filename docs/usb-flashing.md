...
- If WiFi setup does not appear after flashing, look for the setup hotspot named **immich-frame-10inch** or **immich-frame-10-jd9365**, connect to it, then visit `http://192.168.4.1`.
