...
- **ESPHome 2026.7:** Current local builds use ESPHome `2026.7.0`; manual builds also include compatibility fixes for ESPHome 2026.3 and 2026.4 LVGL changes, and for the 2026.7 image schema change.
